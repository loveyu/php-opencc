...
[![Build Status](https://github.com/loveyu/php-opencc/actions/workflows/test.yml/badge.svg)](https://github.com/loveyu/php-opencc/actions/workflows/test.yml)
[![Latest Stable Version](https://poser.pugx.org/loveyu/php-opencc/v/stable)](https://packagist.org/packages/loveyu/php-opencc)
[![Total Downloads](https://poser.pugx.org/loveyu/php-opencc/downloads)](https://packagist.org/packages/loveyu/php-opencc)
[![License](https://poser.pugx.org/loveyu/php-opencc/license)](https://packagist.org/packages/loveyu/php-opencc)
...
- 强烈建议在生产环境开启并配置 Opcache，并将常用字典文件加入 `opcache.preload`，可显著降低首次调用延迟。
  ...
  - `preload.php` 示例：
    ...
    foreach ([
        ...
        require __DIR__.'/vendor/loveyu/php-opencc/data/parsed/'.$name.'.php';
    }
    ```
...
1. File bug reports using the [issue tracker](https://github.com/loveyu/php-opencc/issues).
2. Answer questions or fix bugs on the [issue tracker](https://github.com/loveyu/php-opencc/issues).
